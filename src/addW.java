...
public class addW extends JDialog implements ActionListener{
	
	private JComboBox phaseChoices = null;
    private JComboBox wyborBox=null;
	JTextField tytul, il_wiersz, il_kolumn;
	String disp, Tyt= "";
	int IL_k;
	static int IL_w;
  ...
  public addW(JFrame parent, String title, String message) {
...
//    setSize (400,600);
  ...
  public static void main(String[] a) {
	  addW dlg = new addW(new JFrame(), "title", "message");
  }
...
//		System.out.println(value);
  ...
  public void UactionPerformed(ActionEvent e) {
		...
		if ( (il_wiersz.getText() != null) && (il_wiersz.getText().length() > 0)) {
			disp = "Dodano " + IL_w+" wierszy.";
			MEM.dodaj_w();
	        button2ActionPerformed(null);
		} else  {
			disp = "Pole `ilość wierszy` nie może pozostać puste !";
		}
